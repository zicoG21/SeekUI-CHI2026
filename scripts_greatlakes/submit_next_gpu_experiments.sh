...
sbatch "${sbatch_args[@]}" scripts_greatlakes/multisample_uncertainty.slurm

echo "Submitting OCR crop-level VLM verifier pilot..."
sbatch "${sbatch_args[@]}" scripts_greatlakes/vlm_candidate_crop_verifier.slurm

echo "Submitting OCR+visual crop-level VLM verifier pilot..."
sbatch "${sbatch_args[@]}" scripts_greatlakes/vlm_candidate_crop_visual_verifier.slurm
