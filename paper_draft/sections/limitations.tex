...
The headline result should therefore remain the split-controlled combined AND evaluation. Full-benchmark evidence-aware VLM results are useful for understanding verifier design, but they need matched split validation before becoming the main claim.
