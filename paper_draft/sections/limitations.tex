...
The path-evidence score currently uses an annotation-backed candidate inventory from the released benchmark. This makes the analysis controlled and reproducible, but it is not the same as deploying the verifier on an arbitrary screenshot. A deployable system would need to replace this inventory with automatically proposed UI elements from OCR, accessibility metadata, UI detectors, icon detectors, or VLM crop verification.
